...
/* Wrapper layout agar sejajar dengan sidebar */
.layout {
  display: flex;
  min-height: 100vh;
  width: 100%;
...
/* Sidebar eksternal (diambil dari include sidebar.php) */
.sidebar {
  width: 250px;
  background:#1f2937;
  flex-shrink: 0;
...
.tab{
  background:#fff;padding:10px 16px;border-radius:999px;cursor:pointer;
...
<div class="layout">
  ...
  <main class="main-content">
    <div class="container">
      ...
      <!-- Teks dan tombol digabung langsung ke main -->
